...
import { platform } from './plugins/capacitor'
</script>

<template>
  <div class="relative min-h-screen overflow-x-hidden bg-[var(--bg)]" :data-platform="platform">
    <div
    ...
    <main class="relative z-10 px-4 pb-36 pt-2">
      <RouterView />
    </main>
